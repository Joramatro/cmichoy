...
<html lang="es">
	...
	<div itemscope itemtype="http://schema.org/Article" id="wrapper">
		<div style="display:none"><span itemprop="url">http://www.comprarmicroondashoy.com/microondas/${publicacion.url}</span><span itemprop="publisher">Comprar Microondas Hoy</span></div>		
		<!--start: Container -->
    	<div class="container">
    		...
    		<ul class="breadcrumbs"><li class="home" itemscope itemtype="http://data-vocabulary.org/Breadcrumb"><a name="header.breadcrumb.1" href="<%=result.toString()%>" itemprop="url" title="Página principal" class="migapan"><span itemprop="title">Página principal</span></a></li>
				<li class="crumb0" itemscope itemtype="http://data-vocabulary.org/Breadcrumb"><span>&nbsp;&gt;&nbsp;</span><a name="header.breadcrumb.2" href="<%=result.toString()%>/microondas" itemprop="url" title="Microondas" class="migapan"><span itemprop="title">Microondas</span></a></li>
				<li class="crumb1" itemscope itemtype="http://data-vocabulary.org/Breadcrumb"><span>&nbsp;&gt;&nbsp;</span><a name="header.breadcrumb.3" href="<%=result.toString()%>/microondas?filtro=${fn:replace(publicacion.clase1, " ", separador)}" itemprop="url" title="${publicacion.clase1}" class="migapan"><span itemprop="title">${publicacion.clase1}</span></a></li>
				<c:if test="${not empty publicacion.clase2}">
					<li class="crumb2" itemscope itemtype="http://data-vocabulary.org/Breadcrumb"><span>&nbsp;&gt;&nbsp;</span><a name="header.breadcrumb.4" href="<%=result.toString()%>/microondas?filtro=${fn:replace(publicacion.clase2, " ", separador)}" itemprop="url" title="${publicacion.clase2}" class="migapan"><span itemprop="title">${publicacion.clase2}</span></a></li>				
				</c:if>
				<c:if test="${not empty publicacion.clase7}">
					<li class="crumb3" itemscope itemtype="http://data-vocabulary.org/Breadcrumb"><span>&nbsp;&gt;&nbsp;</span><a name="header.breadcrumb.5" href="<%=result.toString()%>/microondas?filtro=${fn:replace(publicacion.clase7, " ", separador)}" itemprop="url" title="${publicacion.clase7}" class="migapan"><span itemprop="title">${publicacion.clase7}</span></a></li>				
				</c:if>
				<c:if test="${not empty publicacion.clase3}">
					<li class="crumbPrecio" itemscope itemtype="http://data-vocabulary.org/Breadcrumb"><span>&nbsp;&gt;&nbsp;</span><a name="header.breadcrumb.precio" href="<%=result.toString()%>/microondas?filtroPrecio=${fn:replace(publicacion.clase3, " ", separador)}" itemprop="url" title="${publicacion.clase3}" class="migapan"><span itemprop="title">${publicacion.clase3}</span></a></li>				
				</c:if>
			...
			<!-- start: Flexslider -->
			<div style="max-width: 510px;height: 323px; margin: 0 auto;" class="slider" >
				<div id="flex1" class="flexslider home">
					...
					<ul class="slides">
						...
						<c:if test="${status.count ne 3}">
							<li>
								<img style="width: 420px;height: 280px;" src="${imagen}"/>
							</li>
						</c:if>
						</c:forEach>
		      		...
		      		<div class="row">
						...
						<div class="span3">	
							...
							<div class="item-description">
								<h4><a title="${publicacionRel.titulo}" href="/microondas/${publicacionRel.url}">${publicacionRel.titulo}</a></h4>
	...
	<div id="banAmazonHorizontal" style="position:absolute;top:921px;left:54px;color:#F57C17">
		<div style="margin-left: 33px; margin-bottom: 12px;"><b>OFERTAS</b></div>
			...
			<div id="Amazon2prod" class="iframe_wrap">
	    		<iframe src="http://rcm-eu.amazon-adsystem.com/e/cm?t=comprarmicroh-21&o=30&p=8&l=as1&asins=B006VTSRJ0&ref=tf_til&fc1=666666&IS2=1&lt1=_blank&m=amazon&lc1=005580&bc1=EBF7F9&bg1=EBF7F9&f=ifr" style="width:120px;height:240px;" scrolling="no" marginwidth="0" marginheight="0" frameborder="0"></iframe>
	    	</div>

			<div id="Amazon3prod" class="iframe_wrap">
	    		<iframe src="http://rcm-eu.amazon-adsystem.com/e/cm?t=comprarmovsh-21&o=30&p=8&l=as1&asins=B0055ZOY7K&ref=tf_til&fc1=666666&IS2=1&lt1=_blank&m=amazon&lc1=005580&bc1=EBF7F9&bg1=EBF7F9&f=ifr" style="width:120px;height:240px;" scrolling="no" marginwidth="0" marginheight="0" frameborder="0"></iframe>
	    	</div>
	    	<%--
	...
	$(window).scroll(function(){
		if($('#footer').width() >= 855){
		    if($(window).scrollTop() > 901){
				...
				$("#banAmazonHorizontal").css({position:"absolute",top:"921px",left:"54px"});
			}
	    }
	});
	</script>
