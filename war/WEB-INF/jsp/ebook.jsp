								...
								<ul class="carousel">
									...
									<li class="testimonial">
										...
										<c:when test="${comentario.publicacion.tipo eq 'EB' }">
											<div class="testimonials-author"><span itemprop="reviewer">${comentario.nombre}</span>, en <a title="${comentario.publicacion.titulo}" href="/microondas/${comentario.publicacion.url }"><span itemprop="itemreviewed">${comentario.publicacion.titulo}</span></a></div>
										</c:when>	
										<c:otherwise>
	...
	<div id="banAmazonHorizontal" style="position:absolute;top:921px;left:54px;">
		<div style="margin-left: 33px; margin-bottom: 12px;"><b>OFERTAS</b></div>
			...
			<div id="Amazon3prod" class="iframe_wrap">
	    		<iframe src="http://rcm-eu.amazon-adsystem.com/e/cm?t=comprarmicroh-21&o=30&p=8&l=as1&asins=B003CP0Z7S&ref=tf_til&fc1=666666&IS2=1&lt1=_blank&m=amazon&lc1=005580&bc1=EBF7F9&bg1=EBF7F9&f=ifr" style="width:120px;height:240px;" scrolling="no" marginwidth="0" marginheight="0" frameborder="0"></iframe>   		
	    	</div>
	    	<%--
