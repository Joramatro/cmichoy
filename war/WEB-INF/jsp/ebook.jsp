...
<html lang="es">
	...
	<div itemscope itemtype="http://schema.org/Article" id="wrapper">
    	...
    	<div class="container">
	    	...
	    	<div id="banGoogle" class="iframe_wrap" style="position:absolute;margin-left: 846px;margin-top: 90px;">
			...
			<!-- start: Flexslider -->
			<div style="width: 470px;height: 323px; margin: 0 auto;" class="slider" >
	...
	<div id="banAmazonHorizontal" style="position:absolute;top:921px;left:54px;">
