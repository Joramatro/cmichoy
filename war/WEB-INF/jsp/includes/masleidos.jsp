						...
						<div class="span3">	
							<div class="picture">
								<a href="/microondas/${publicacionMVE.url}" title="${publicacionMVE.titulo}">
									...
									<img style="width: 270px;height: 200px;" class="lazy" data-original="${publicacionMVE.lImages[1]}" alt="${publicacionMVE.titulo}"/>
									</c:if>
									<div class="image-overlay-link"></div>
								</a>
							</div>
							<div class="item-description">
								<h4><a title="${publicacionMVE.titulo}" href="/microondas/${publicacionMVE.url}">${publicacionMVE.titulo}</a></h4>
								...
								<ul class="carousel">
									...
									<li class="testimonial">
										...
										<c:when test="${comentario.publicacion.tipo eq 'EB' }">
											<div class="testimonials-author">${comentario.nombre}, en <a title="${comentario.publicacion.titulo}" href="/microondas/${comentario.publicacion.url }">${comentario.publicacion.titulo}</a></div>
										</c:when>	
										<c:otherwise>
