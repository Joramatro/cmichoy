...
<html lang="es">
	...
	<div itemscope itemtype="http://schema.org/Article" id="wrapper">
		<div style="display:none"><span itemprop="url">http://www.comprarmicroondashoy.com/blog/${publicacion.url}</span><span itemprop="publisher">Comprar Microondas Hoy</span></div>		
		<!--start: Container -->
    	<div class="container">
    		...
    		<ul class="breadcrumbs"><li class="home" itemscope itemtype="http://data-vocabulary.org/Breadcrumb"><a name="header.breadcrumb.1" href="<%=result.toString()%>" itemprop="url" title="Página principal" class="migapan"><span itemprop="title">Página principal</span></a></li>
				<li class="crumb0" itemscope itemtype="http://data-vocabulary.org/Breadcrumb"><span>&nbsp;&gt;&nbsp;</span><a name="header.breadcrumb.2" href="<%=result.toString()%>/blog" itemprop="url" title="Blog Microondas" class="migapan"><span itemprop="title">Blog Microondas</span></a></li>
			...
			<% 
				//Realmente saltos de línea controlados en servlet
